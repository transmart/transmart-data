...
--
-- Type: INDEX; Owner: DEAPP; Name: DE_RC_SNP_INFO_HG_RS
--
CREATE INDEX "DEAPP"."DE_RC_SNP_INFO_HG_RS" ON "DEAPP"."DE_RC_SNP_INFO" ("HG_VERSION", "RS_ID")
TABLESPACE "TRANSMART" ;
--
-- Type: INDEX; Owner: DEAPP; Name: DE_RC_SNP_INFO_CHROM
--
CREATE INDEX "DEAPP"."DE_RC_SNP_INFO_CHROM" ON "DEAPP"."DE_RC_SNP_INFO" ("CHROM")
TABLESPACE "TRANSMART" ;
--
-- Type: INDEX; Owner: DEAPP; Name: DE_RC_SNP_INFO_POS
--
CREATE INDEX "DEAPP"."DE_RC_SNP_INFO_POS" ON "DEAPP"."DE_RC_SNP_INFO" ("POS")
TABLESPACE "TRANSMART" ;
